...
import { sampleWithRequiredData } from '../restaurant-order.test-samples';
...
describe('RestaurantOrder Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.restaurantOrders()[0]).toEqual(expect.objectContaining({ id: 2705 }));
  });

  describe('trackId', () => {
    it('should forward to restaurantOrderService', () => {
      const entity = { id: 2705 };
      jest.spyOn(service, 'getRestaurantOrderIdentifier');
      const id = comp.trackId(entity);
      expect(service.getRestaurantOrderIdentifier).toHaveBeenCalledWith(entity);
