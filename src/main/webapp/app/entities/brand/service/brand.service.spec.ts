...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../brand.test-samples';

import { BrandService, RestBrand } from './brand.service';

const requireRestSample: RestBrand = {
