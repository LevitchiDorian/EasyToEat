...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'fa69011f-eef7-45b3-8c93-1bbed862f9b6' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('dc1a4036-ea75-4d6f-ae0c-15fe65aabeba');
      cy.get(`[data-cy="name"]`).should('have.value', 'dc1a4036-ea75-4d6f-ae0c-15fe65aabeba');
