...
import { EntityArrayResponseType, MenuItemService } from '../service/menu-item.service';
...
export class MenuItemComponent implements OnInit {
  ...
  trackId = (item: IMenuItem): number => this.menuItemService.getMenuItemIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.menuItems.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IMenuItem[] | null): IMenuItem[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.menuItemService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
