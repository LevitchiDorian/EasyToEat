...
import { sampleWithRequiredData } from '../restaurant-table.test-samples';
...
describe('RestaurantTable Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.restaurantTables()[0]).toEqual(expect.objectContaining({ id: 23892 }));
  });

  describe('trackId', () => {
    it('should forward to restaurantTableService', () => {
      const entity = { id: 23892 };
      jest.spyOn(service, 'getRestaurantTableIdentifier');
      const id = comp.trackId(entity);
      expect(service.getRestaurantTableIdentifier).toHaveBeenCalledWith(entity);
