...
import java.util.*;
import md.utm.restaurant.config.Constants;
...
import md.utm.restaurant.service.UserService;
import md.utm.restaurant.service.dto.AdminUserDTO;
import md.utm.restaurant.web.rest.errors.BadRequestAlertException;
import md.utm.restaurant.web.rest.errors.EmailAlreadyUsedException;
import md.utm.restaurant.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link md.utm.restaurant.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
