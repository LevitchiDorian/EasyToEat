...
const requireRestSample: RestReservation = {
  ...
  reservationDate: sampleWithRequiredData.reservationDate?.format(DATE_FORMAT),
  reminderSentAt: sampleWithRequiredData.reminderSentAt?.toJSON(),
  confirmedAt: sampleWithRequiredData.confirmedAt?.toJSON(),
  cancelledAt: sampleWithRequiredData.cancelledAt?.toJSON(),
