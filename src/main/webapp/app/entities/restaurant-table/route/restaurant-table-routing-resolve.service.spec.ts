...
import restaurantTableResolve from './restaurant-table-routing-resolve.service';

describe('RestaurantTable routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: RestaurantTableService;
  let resultRestaurantTable: IRestaurantTable | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IRestaurantTable returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        restaurantTableResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultRestaurantTable).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IRestaurantTable>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
