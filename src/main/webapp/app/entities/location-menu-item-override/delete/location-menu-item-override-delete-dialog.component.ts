...
@Component({
  templateUrl: './location-menu-item-override-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class LocationMenuItemOverrideDeleteDialogComponent {
  locationMenuItemOverride?: ILocationMenuItemOverride;
  ...
  confirmDelete(id: number): void {
    this.locationMenuItemOverrideService.delete(id).subscribe(() => {
