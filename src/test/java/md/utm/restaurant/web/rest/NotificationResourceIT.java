...
import static md.utm.restaurant.domain.NotificationAsserts.*;
...
import md.utm.restaurant.repository.NotificationRepository;
import md.utm.restaurant.repository.UserRepository;
import md.utm.restaurant.service.NotificationService;
import md.utm.restaurant.service.dto.NotificationDTO;
import md.utm.restaurant.service.mapper.NotificationMapper;
...
class NotificationResourceIT {
    ...
    private static final NotificationType DEFAULT_TYPE = NotificationType.RESERVATION_CONFIRMED;
    private static final NotificationType UPDATED_TYPE = NotificationType.RESERVATION_CANCELLED;

    private static final NotificationChannel DEFAULT_CHANNEL = NotificationChannel.EMAIL;
    private static final NotificationChannel UPDATED_CHANNEL = NotificationChannel.IN_APP;
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.type(UPDATED_TYPE).body(UPDATED_BODY).sentAt(UPDATED_SENT_AT);
