...
import md.utm.restaurant.service.mapper.OrderItemMapper;
...
class OrderItemResourceIT {
    ...
    public static OrderItem createUpdatedEntity(EntityManager em) {
        ...
        updatedOrderItem.setOrder(restaurantOrder);
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.status(UPDATED_STATUS).notes(UPDATED_NOTES);
