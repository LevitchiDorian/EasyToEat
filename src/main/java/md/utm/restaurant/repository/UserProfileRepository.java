...
public interface UserProfileRepository extends JpaRepository<UserProfile, Long>, JpaSpecificationExecutor<UserProfile> {
    ...
    @Query(
        value = "select userProfile from UserProfile userProfile left join fetch userProfile.user left join fetch userProfile.location",
    ...
    @Query("select userProfile from UserProfile userProfile left join fetch userProfile.user left join fetch userProfile.location")
