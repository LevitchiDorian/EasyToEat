...
import { sampleWithRequiredData } from '../dining-room.test-samples';
import { DiningRoomService } from '../service/dining-room.service';

import { DiningRoomComponent } from './dining-room.component';
import SpyInstance = jest.SpyInstance;

describe('DiningRoom Management Component', () => {
  let comp: DiningRoomComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(DiningRoomComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.diningRooms()[0]).toEqual(expect.objectContaining({ id: 3993 }));
  });

  describe('trackId', () => {
    it('should forward to diningRoomService', () => {
      const entity = { id: 3993 };
      jest.spyOn(service, 'getDiningRoomIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDiningRoomIdentifier).toHaveBeenCalledWith(entity);
